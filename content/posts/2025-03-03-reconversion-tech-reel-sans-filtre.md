...
title: "Reconversion vers la tech : le réel sans filtre"
date: 2025-03-03
...
"La tech recrute, reconvertis-toi en 3 mois, salaire doublé garanti." Ce discours marketing occulte la réalité : la reconversion est possible mais exigeante, avec des vrais défis et pas de garantie.

Ce que j'ai observé : des reconversions réussies existent. Mais le chemin est plus long et difficile que ce que les bootcamps te vendent.

## Le faux problème

Le faux problème serait de croire que la tech résoudra tous tes problèmes professionnels. En réalité, c'est un secteur avec ses propres défis, frustrations et toxicités.

Un autre faux problème : penser que 3 mois de bootcamp suffisent à rattraper 4 ans d'études + 2 ans d'expérience. En réalité, tu seras junior, avec salaire et responsabilités de junior.

## Le vrai enjeu

Le vrai enjeu est de comprendre ce qui t'attend vraiment :
...
**Questions:** Pourquoi la tech ? Prêt à être junior à 30-40 ans ? Capable d'investir 10-20h/semaine 6-12 mois ? Accepter baisse salaire temporaire ? Si oui à tout, continuer. Sinon, repenser.

**2. Formation structurée mais pas suffisante**
Bootcamp/formation : donne bases et structure. Mais : compléter avec projets perso, contributions open source, veille. Ces extras font la différence à l'embauche.

**3. Construire portfolio concret**
...
**La reconversion qui échoue** : Bootcamp 3 mois. Attentes : 50k immédiat. Refuse offres <45k. 9 mois sans job. Compétences s'érodent. Abandon. **Message:** attentes irréalistes tuent reconversion.

**La reconversion qui réussit** : Bootcamp + 6 mois projets perso. Accepte premier job 32k (baisse vs ancien salaire). 18 mois : promo → 40k. 3 ans : senior → 52k. **Message:** accepter départ bas, progresser vite.

**L'exemple du réseau** : Reconversion à 35 ans. Utilise réseau professionnel antérieur. Ancien collègue recrute dans sa boîte. Premier job via réseau, pas candidature froide. **Message:** réseau existant est atout majeur.

**Le syndrome de l'imposteur** : Reconversion à 40 ans, équipe de juniors 23-25 ans. Sentiment d'être "trop vieux". **Réalité:** équipe valorise maturité professionnelle, expérience terrain. 1 an : devient référent, pas pour tech (junior) mais pour processus/communication. **Message:** ton expérience a de la valeur.

## Erreurs fréquentes (et comment les éviter)

**Erreur 1 - Se fier aux promesses marketing**
**Piège:** "50k garanti, 100% embauche, 3 mois suffisent." **Réalité:** timeline et salaires plus longs/bas. **Correction:** rechercher témoignages réels, pas juste pub.

**Erreur 2 - Négliger projets perso**
**Piège:** bootcamp → attendre job. **Réalité:** sans portfolio, difficile de se différencier. **Correction:** construire 2-3 projets perso pendant recherche.

**Erreur 3 - Viser trop haut immédiatement**
**Piège:** refuser jobs juniors, viser senior directement. **Réalité:** sans expérience, impossible. **Correction:** premier job = expérience, pas perfection.

**Erreur 4 - Abandonner trop tôt**
**Piège:** 30 refus → découragement → abandon. **Réalité:** 50-150 candidatures est normal. **Correction:** persévérer, améliorer CV/portfolio entre temps.

## Message de responsabilité

La reconversion est possible, mais exigeante. Ce qui dépend de toi :

- **Tu es responsable** d'avoir des attentes réalistes sur salaire et timeline
- **Tu es responsable** d'investir temps perso au-delà de la formation
- **Tu es responsable** de construire portfolio et réseau
- **Tu es responsable** de persévérer face aux refus

La tech n'est ni un eldorado ni une arnaque. C'est un secteur avec opportunités ET défis. Ta réussite dépend de ton investissement et réalisme.
...
Tu peux aussi consulter l'article [\"De non-tech à tech : ce qui change\"](/posts/non-tech-vers-tech-ce-qui-change/) ou les autres contenus du pilier [\"Trouver sa place\"](/articles/?cat=parcours).
